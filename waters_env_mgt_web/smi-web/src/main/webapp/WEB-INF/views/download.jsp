...
<body>
       	...
       	<div class="nTab">
            <!-- nTab --> 
                <div class="TabTitle"> 
                    ...
                    <li class="active" onclick="nTabs(this,4);"><a href="${ctx}/index/download" class="font_b">下载手机APP</a></li>
    ...
    <!-- pic --> 
    <div class="dbg_f">
    	<img src="${ctx}/static/image/xiaz_bg.png" width="100%" />
    </div>
    <!-- pic over -->
    ...
    <div class="dbg_f">
        ...
        <!-- login --> 
			<div class="tep">
				<img src="${ctx}/static/image/tep_bg.png" width="100%" />
				<div class="tep_01"><img src="${ctx}/static/image/tep01.png" width="100%" /><br /><br />扫一扫 直接下载APP</div>
				<div class="tep_02"><img src="${ctx}/static/image/tep02.png" width="100%" /></div>
        	</div>
        <!-- login over -->
  		</div>
	</div>
