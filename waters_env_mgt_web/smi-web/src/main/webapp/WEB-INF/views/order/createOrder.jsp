...
function saveOrder() {
	...
	$('#fm').form('submit', {
		url : '${ctx}/orders/createOrders',
		onSubmit : function() {
			if( adress ==''){
				$.messager.alert('温馨提示','作业地点为必填!','info');
				return false;
			}
			if( workDate ==''){
    ...
    <div class="dbg" style="background-color:#fafafa; padding-bottom:30px;">
        ...
        <!-- order --> 
        	<div class="order">
    			...
    			<form id="fm" method="post" action="${ctx}/orders/createOrders">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td width="18%" align="right">船名：</td>
                    <td width="28%" align="left">
                    	<input class="easyui-combobox" id="customerShipId" name="customerShipId" style="width: 155px" data-options="required:true,valueField:'customerShipId',textField:'customerShipName',url: '${ctx}/orders/shipList'"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="left">
                    	 <input class="text" id="adress" name="adress" style="width: 155px" required="required"/>
                   		 <%-- <input class="easyui-combobox" id="adress" name="adress" style="width: 155px" data-options="required:true,valueField:'dataValue',textField:'dataName',url: '${ctx}/orders/dictionaryList?dataType=WS_ADDRESS'"/> --%>
                    </td>
                    <td align="right"><span class="red">*</span> 作业时间：</td>
                    <td align="left">
                	 <input id="workDate" name="workDate" type="text" required="required" class="query Wdate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d {%H+2}'})"/>
                    </td>
                  </tr>
                  <tr>
                    <td align="right"></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    ...
                    <td width="28%" align="left"><input id="ifType1" name="ifType" type="radio"  value="0" /> 是&nbsp;&nbsp;&nbsp;&nbsp;<input id="ifType2" name="ifType" type="radio" value="1" /> 否</td>
                    <td width="18%" align="right"></td>
                    <td align="left"></td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td>
                    <textarea class="style_textarea" name="memo" cols="" rows=""></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>
